...
itemInformation.itemList = [
    ...
    { id: 15, name: "不死身の雫", value: 10000000000, effect: itemEffect.ressurrectionSmall, statement: "自分のHPが0になったターンの終了時，確定で発動します．HPを最大HPの1/200にします．" ,kind:"phaseZero"},
    { id: 16, name: "不死身の土塊", value: 50000000000, effect: itemEffect.ressurrectionMedium, statement: "自分のHPが0になったターンの終了時，確定で発動します．HPを最大HPの1/20にします．" ,kind:"phaseZero"},
    { id: 17, name: "不死身の果実", value: 100000000000, effect: itemEffect.ressurrectionLarge, statement: "自分のHPが0になったターンの終了時，確定で発動します．HPを最大HPの1/2にします．" ,kind:"phaseZero"},
