...
itemInformation.accessoryList = [
    ...
    { id: 9, name: "戒めの粉", value: 7000000, effect: itemEffect.none, state: "敵が禁断魔法を使用した際のみ発動します．そのダメージを敵に与えます．" },
    { id: 10, name: "戒めのお守り", value: 600000000, effect: itemEffect.none, state: "敵が禁断魔法を使用した際のみ発動します．そのダメージを敵に与えます．" },
    { id: 11, name: "ブライノイズ", value: 7000000, effect: itemEffect.none, state: "敵が時空魔法を使用した際のみ発動します．そのダメージを1/2にします．" },
    { id: 12, name: "次元障壁", value: 600000000, effect: itemEffect.none, state: "敵が時空魔法を使用した際のみ発動します．そのダメージを0にします．" },
    { id: 13, name: "騎士の盾", value: 7000000, effect: itemEffect.none, state: "敵が斬鉄剣を使用した際のみ発動します．そのダメージを1/2にします．" },
    { id: 14, name: "勇者の盾", value: 600000000, effect: itemEffect.none, state: "敵が斬鉄剣を使用した際のみ発動します．そのダメージを0にします．" },
    { id: 15, name: "不死身の雫", value: 7000000, effect: itemEffect.none, state: "自分のHPが0になったとき，確定で発動します．HPを最大HPの1/200にします．" },
    { id: 16, name: "不死身の土塊", value: 600000000, effect: itemEffect.none, state: "自分のHPが0になったとき，確定で発動します．HPを最大HPの1/20にします．" },
    { id: 17, name: "不死身の果実", value: 600000000, effect: itemEffect.none, state: "自分のHPが0になったとき，確定で発動します．HPを最大HPの1/2にします．" },
